...
const NavBar: FC = () => {
  return (
    <div className="flex flex-col flex-auto h-screen bg-skin-accent-dark">
      ...
      <NavBarItem content="APPLICATIONS">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-8 w-8"
          fill="none"
